...
(*Il secondo set di stringhe è sottoinsieme del primo ? True*)

eval(CheckSubset(setStringhe,setStringhe2)) env;;  

(*Il primo set è vuoto? False*)
